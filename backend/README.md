...
## Project Structure
    ...
    ├── taylor_cv_exercise_37252  # Django project configurations
...
1. Clone this repo and `cd taylor_cv_exercise_37252`
...
2. Clone this repo and `cd taylor_cv_exercise_37252`
